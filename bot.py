...
# =============================================
# SNIPER BOT v11.3 - VERSION FINAL COMPLETA
# =============================================
# ANTES DE SUBIR:
...
COOLDOWN        = 300    # 5 min entre senales iguales
NEWS_COOLDOWN   = 1800   # 30 min entre alertas de noticias
MAX_SIGNAL_AGE  = 7200   # 2h max por senal activa
SUMMARY_HOUR    = 23     # hora del resumen diario
...
def check_news():
    ...
    try:
        ...
        if high_impact and time.time() - last_news_alert > NEWS_COOLDOWN:
            ...
            log(f'Alerta noticias: {len(high_impact)} eventos')
    except Exception as e:
        log(f'News error: {e}')
...
def analyze_and_alert(asset_key, prices):
    ...
    # Registrar para seguimiento TP/SL
...
def main():
    ...
    while True:
        try:
            ...
            # Confirmar TP/SL de senales abiertas
