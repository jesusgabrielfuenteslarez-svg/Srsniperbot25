...
SCORE_NORMAL   = 55   # señal estándar
SCORE_POST_SL  = 65   # más exigente tras un SL
...
trade_log     = []
daily_pnl     = 0.0
last_sl       = {'gold': False, 'btc': False}  # racha SL por activo
last_d_report = None
...
def try_signal(asset, data, data_h1=None):
    ...
    threshold = SCORE_POST_SL if last_sl[asset] else SCORE_NORMAL
